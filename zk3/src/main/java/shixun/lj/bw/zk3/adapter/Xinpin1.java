...
/*
  name:刘江
  data:2019
*/public class Xinpin1 extends RecyclerView.Adapter<Xinpin1.Myciewholder> {

    List<Data.ResultBean.RxxpBean.CommodityListBean> list;
    Context context;


    public Xinpin1(List<Data.ResultBean.RxxpBean.CommodityListBean> list, Context context) {
        this.list = list;
    ...
    public Myciewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.xinpin1, null, false);
    ...
    class Myciewholder extends RecyclerView.ViewHolder {
        ...
        public Myciewholder(@NonNull View itemView) {
            ...
            t1 = itemView.findViewById(R.id.xt11);
        }
    }
}
